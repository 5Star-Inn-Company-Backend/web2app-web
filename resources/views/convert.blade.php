                                    ...
                                    <div class="col text-center">
                                        ...
                                        <div class="spacer-single"></div>
                                            ...
                                            <div class="col text-center">
                                                ...
                                                <input class="form-control" id='name_1' name='url' placeholder="Type your website url here" type='text'> <a id="btn-submit" onclick="document.getElementById('form_sb').submit();"><i class="arrow_right"></i></a>
                                                ...
                                                <div class="domain-ext">
                                                    <div class="ext">
                                                        <h4>Basic Plan</h4>
                                                        $50
                                                        <input name="plan" type="radio" id="radio_30" class="with-gap radio-col-primary" value="basic" checked="">
                                                    </div>

                                                    <div class="ext">
                                                        <h4>Gold Plan</h4>
                                                        $110
                                                        <input name="plan" type="radio" id="radio_32" class="with-gap radio-col-success" value="gold">
                                                    </div>

                                                    <div class="ext">
                                                        <h4>Premium Plan</h4>
                                                        $200
                                                        <input name="plan" type="radio" id="radio_33" class="with-gap radio-col-info" value="premium">
                                                    </div>

                                                    <div class="ext">
                                                        <h4>Free trial</h4>
                                                        $0
                                                        <input name="plan" type="radio" id="radio_35" class="with-gap radio-col-warning" value="free">
                                                    </div>
                                                </div>
                                ...
                                <div class="accordion">
                                    <div class="accordion-section">
                                        ...
                                        <div class="accordion-section-content" id="accordion-1">
                                            ...
                                            <input class="form-control" name='appname' placeholder="Type your app name" type='text'>
                                        </div>
                                        ...
                                        <div class="accordion-section-content" id="accordion-2">
                                            ...
                                            <input class="form-control-file" name='icon' placeholder="Type your app name" type='file'>
                                        </div>
                                        <div class="accordion-section-title" data-tab="#accordion-3">
                                            Full Screen
                                        </div>
                                        <div class="accordion-section-content" id="accordion-3">
                                            <p>Selecting true means you want to disregard bottom navigation and header</p>
                                        ...
                                        <div class="accordion-section-content" id="accordion-4">
                                            ...
                                            <input class="form-control" name='primarycolor' placeholder="Type your app name" type='color'>
                                        </div>
                                ...
                                <div class="accordion">
                                    <div class="accordion-section">
                                        ...
                                        <div class="accordion-section-content" id="accordion-b-1">
                                            ...
                                            <input class="form-control" name='packagename' placeholder="e.g com.appname" type='text'>
                                        </div>
                                        ...
                                        <div class="accordion-section-content" id="accordion-b-3">
                                            ...
                                            <input class="form-control" name='admobID' placeholder="Admob ID" type='text'>
                                        </div>
